                                    ...
                                    <div class="card-body depostit-card">
                                        ...
                                        <div class="progress-box mt-0">
                                            <div class="d-flex justify-content-between">
                                                <p class="mb-0">Invoices Not Finished</p>
                                                <p class="mb-0">20/28</p>
                                            </div>
                                            <div class="progress">
                                                <div class="progress-bar bg-primary" style={{ width: '70%', height: '5px', borderRadius: '4px' }} role="progressbar"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="col-xl-4">
                                <div className="card">
                                    <div className="card-header border-0">
                                        ...
                                        <div>
                                            <a className="text-primary me-2">View All</a>
                                            <a className="text-black"> + Add To Do</a>
                                        </div>
                                    </div>
                                    <div className="card-body p-0">
