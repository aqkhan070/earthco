    ...
    return (
        <>
            <div className="nav-header">
                <a className="brand-logo" style={{ background: '#fff' }}>
                    ...
                    <img style={{ width: '45%', marginLeft: "20%" }} src="./assets/images/logo/earthco_logo.png" alt="" />
                </a>
                        ...
                        <div className="collapse navbar-collapse justify-content-between">
                            <div className="header-left">
                                <div className="input-group search-area">
                                    {/* <span className="input-group-text"><a>
                            ...
                            <ul className="navbar-nav header-right">
                                ...
                                <NavLink to='/' style={{ display: 'contents' }}>
                                    <li className="nav-item align-items-center header-border"><a className="btn btn-primary btn-sm">Logout</a></li>
                                </NavLink>
                                            ...
                                            <div className="card border-0 mb-0">
                                                <div className="card-header py-2">
                                                    <div className="products">
                                                        <img src='./assets/images/profile/profile.png' className="avatar avatar-md" alt="" />
                                                        <div>
                                                            <h6>Admin</h6>
